<nav class="navbar navbar-expand-lg navbar-dark shadow-sm sticky-top navbar-premium" style="background: var(--premium-gradient-green);">
    <div class="container">
        <a class="navbar-brand navbar-brand-premium" href="dashboard.php">
            <i class="fas fa-leaf me-2"></i>Agro-Haat
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav align-items-center">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="manage_products.php">Inventory</a>
                </li>
                <li class="nav-item dropdown ms-lg-3">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow border-0 animate-fade-in-up">
                        <li><a class="dropdown-item" href="../profile.php"><i class="fas fa-user-circle me-2 text-success"></i> My Profile</a></li>
